...
#define STRING_CONFIG_H_AUTHOR "(Pia 3D, mks-robin-e3d-v1_1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Pia 3D - MKS Robin E3D"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -18, -1.46}
